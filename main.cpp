...
int main() {
	...
	GunFactory* gunFactory = new GunFactory(&factoryName, workersCount, workerEfficiency, gunCaliber, gunAmmoCapacity);
	...
	ButterFactory* butterFactory = new ButterFactory(&factoryName, workersCount, workerEfficiency, butterFatContent, butterShelfLife);
	...
	butterFactory->produceButterPacks();
	...
	cout << "4) ¬ведите теспературу работы холодильника" << endl;
	...
	FridgeFactory* fridgeFactory = new FridgeFactory(&factoryName, workersCount, workerEfficiency, fridgeWorkingTemperature, fridgeNumOfRacks);
